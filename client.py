...
def play_video(sdp_loc, port, video, resolution):
    print("Playing video")
    subprocess.Popen(
        "ffplay -protocol_whitelist file,rtps,udp -srtp_in_suite AES_CM_128_HMAC_SHA1_80 -srtp_in_params " +
    ...
    try:
        if resolution == "" or resolution == "0":
            ...
            if resolution % 2 != 0:
                ...
                print("Resolution must be even, defaulting to " + str(resolution))
    except:
